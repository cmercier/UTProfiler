    ...
    uv_(uv)
{
    ...
    QObject::connect(codeEdit,SIGNAL(textChanged(QString)),&uv_,SLOT(setCode(QString)));
    ...
    QObject::connect(titleEdit,SIGNAL(textChanged(QString)),&uv_,SLOT(setTitle(QString)));
    ...
    QObject::connect(creditsBox,SIGNAL(valueChanged(int)),&uv_,SLOT(setCredits(int)));
    ...
    QObject::connect(categoryBox,SIGNAL(activated(QString)),&uv_,SLOT(setCategory(QString)));
    ...
    QObject::connect(spring,SIGNAL(toggled(bool)),&uv_,SLOT(setSpring(bool)));
    QObject::connect(fall,SIGNAL(toggled(bool)),&uv_,SLOT(setFall(bool)));
}
...
Admin::Admin()
{
    ...
    Uv* uv = new Uv();
    addUvPanel_= new UvInputView(*uv);
